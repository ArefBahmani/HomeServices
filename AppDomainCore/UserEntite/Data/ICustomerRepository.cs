...
namespace AppDomainCore.UserEntite.Data
{
    ...
    {
        public Task<bool> Add(Customer customer,CancellationToken cancellation);
        public Task<bool> Delete(int customerId,CancellationToken cancellation);
        public Task<bool> Edit(int CustomerId,Customer customer,CancellationToken cancellation);    
